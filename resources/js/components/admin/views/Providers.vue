              ...
              <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="myModalLabel"> {{trans('lang.providers')}} </h5>
                      ...
                      <div class="modal-body">
                          <form @submit.prevent="editMode?update():create()">
                              <div class="row">
                                  ...
                                  <div class="form-group text-left" v-if="editMode">
    ...
    <table class="table mb-0">
        <thead class="table-light">
            <tr>
                ...
                <th style="min-width:120px" scope="col">Options</th>
            </tr>
        </thead>
        <tbody>
            <tr v-for="item,index in tableData.data" :key="index">
                ...
                <td>{{item.address}}</td>
                <td>
                     <div class="badge badge-soft-primary" v-if="item.is_company==0 || item.is_company==null"> Individual </div> 
                     <div class="badge badge-soft-danger" v-else> Company </div> 
                </td>
                <td>
...
export default {
    ...
    methods:{
        ...
        getData(){
            ...
            axios.get('/admin/admin_api/providers')
                 .then((resp)=>{
        ...
        create(){
            this.form.post('/admin/admin_api/providers')
                .then((resp)=>{
                    Fire.$emit('Load')
                    //alert
        ...
        update(){
            this.form.put('/admin/admin_api/providers/'+this.form.id)
                .then(()=>{
                    Fire.$emit('Load')
                    //alert
        ...
        del(){
          this.form.delete('/admin/admin_api/providers/'+this.item.id)
                        .then(()=>{ 
                         Fire.$emit('Load');
         ...
         getResults(page = 1) {
            ...
            axios.get('/admin/admin_api/providers?page=' + page)
                .then(({data}) => (
                    this.tableData = data
                ))
        },
        searching(){
               let query=this.$root.search;
                this.$root.loading=true
              if(query.length != 0){                
              axios.get('/admin/admin_api/providers/search/'+query)
                        .then((response)=>{  
