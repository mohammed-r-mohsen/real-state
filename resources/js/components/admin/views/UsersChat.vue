                                                        ...
                                                        <li class="list-inline-item m-0">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    <a class="dropdown-item" href="#"><i class="ri-delete-bin-5-line align-bottom text-muted me-2"></i> {{trans('lang.delete')}}</a>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                                ...
                                                                <div class="ctext-wrap">
                                                                    ...
                                                                    <div class="dropdown align-self-start message-box-drop">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            <a @click="del()" class="dropdown-item delete-item" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>{{trans('lang.delete')}}</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                                ...
                                                                                <ul class="list-inline mb-0">
                                                                                    <li class="list-inline-item dropdown">
                                                                                        ...
                                                                                        <div class="dropdown-menu">
                                                                                            ...
                                                                                            <a class="dropdown-item" href="#"><i class="ri-share-line me-2 text-muted align-bottom"></i>Forward</a>
                                                                                            <a class="dropdown-item" href="#"><i class="ri-bookmark-line me-2 text-muted align-bottom"></i>Bookmark</a>
                                                                                            <a class="dropdown-item delete-image" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>{{trans('lang.delete')}}</a>
                                                                                        </div>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
