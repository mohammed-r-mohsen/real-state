              ...
              <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="myModalLabel"> {{trans('lang.appart_model')}} </h5>
                              ...
                              <div class="row">
                                  <div class="col-lg-12">
                                      <div class="mb-3">
                                          ...
                                          <input required :class="{ 'is-invalid': form.errors.has('name') } " v-model="form.name"  class="form-control" id="teammembersname" >
...
export default {
    ...
    methods:{
        ...
        getData(){
            ...
            axios.get('/admin/admin_api/appart_models')
                 .then((resp)=>{
        ...
        create(){
            this.form.post('/admin/admin_api/appart_models')
                .then((resp)=>{
                    Fire.$emit('Load')
                    //alert
        ...
        update(){
            this.form.put('/admin/admin_api/appart_models/'+this.form.id)
                .then(()=>{
                    Fire.$emit('Load')
                    //alert
        ...
        del(){
          this.form.delete('/admin/admin_api/appart_models/'+this.item.id)
                        .then(()=>{ 
                         Fire.$emit('Load');
         ...
         getResults(page = 1) {
            ...
            axios.get('/admin/admin_api/appart_models?page=' + page)
                .then(({data}) => (
                    this.tableData = data
                ))
        },
        searching(){
               let query=this.$root.search;
                this.$root.loading=true
              if(query.length != 0){                
              axios.get('/admin/admin_api/appart_models/search/'+query)
                        .then((response)=>{  
