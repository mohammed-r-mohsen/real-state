              ...
              <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="myModalLabel"> {{trans('lang.categories')}} </h5>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-lg-12">
                                      <div class="mb-3">
                                          ...
                                          <input :class="{ 'is-invalid': form.errors.has('image') }" @change="upload" type="file" class="form-control" id="userimage">
    ...
    <table class="table table-nowrap mb-0">
        ...
        <tbody>
            <tr v-for="item,index in tableData.data" :key="index">
                ...
                <td><img class="table-img" v-if="item.image" :src="item.image"></td>
                <td>
...
export default {
    ...
    methods:{
        ...
        getData(){
            ...
            axios.get('/admin/admin_api/categories')
                 .then((resp)=>{
        ...
        create(){
            this.form.post('/admin/admin_api/categories')
                .then((resp)=>{
                    Fire.$emit('Load')
                    //alert
        ...
        update(){
            this.form.put('/admin/admin_api/categories/'+this.form.id)
                .then(()=>{
                    Fire.$emit('Load')
                    //alert
        ...
        del(){
          this.form.delete('/admin/admin_api/categories/'+this.item.id)
                        .then(()=>{ 
                         Fire.$emit('Load');
         ...
         getResults(page = 1) {
            ...
            axios.get('/admin/admin_api/categories?page=' + page)
                .then(({data}) => (
                    this.tableData = data
                ))
        },
